    ...
    export default {
        ...
        methods: {
            ...
            searchCustomer(page){
              ...
              axios.get('/pos/kasir/search_customer?q='+app.pencarian+'&page='+page).then(response => {
            ...
            getVueCustomer(page) {
                axios.get('/pos/kasir/data_customer?page=' + page).then(response => {
                    this.items = response.data.data.data,
                    this.pagination = response.data.pagination
                });
            },
            ...
            createCustomer() {
                ...
                axios.post('/pos/kasir/simpan_customer', input).then((response) => {
            ...
            deleteCustomer(item) {
                if (confirm("Yakin ingin menghapus customer : "+item.nama_customer+" ?")) {
                    axios.delete('/pos/kasir/destroy_customer/' + item.id).then((response) => {
                        this.changePage(this.pagination.current_page);
            ...
            updateCustomer(id) {
                ...
                axios.put('/pos/kasir/update_customer/' + id, input).then((response) => {
                    this.changePage(this.pagination.current_page);
                    this.fillItem = {
                        'nomor_kartu': '',
                        'nomor_kartu_old': '',
