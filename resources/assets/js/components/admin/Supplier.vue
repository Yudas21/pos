    ...
    export default {
        ...
        methods: {
            ...
            searchSupplier(page){
              ...
              axios.get('/pos/admin/search_supplier?q='+app.pencarian+'&page='+page).then(response => {
            ...
            getVueSupplier(page) {
                axios.get('/pos/admin/data_supplier?page=' + page).then(response => {
                    this.items = response.data.data.data,
                    this.pagination = response.data.pagination
                });
            },
            ...
            createSupplier() {
                ...
                axios.post('/pos/admin/simpan_supplier', input).then((response) => {
            ...
            deleteSupplier(item) {
                if (confirm("Yakin ingin menghapus supplier : "+item.nama_supplier+" ?")) {
                    axios.delete('/pos/admin/destroy_supplier/' + item.id).then((response) => {
                        this.changePage(this.pagination.current_page);
            ...
            updateSupplier(id) {
                ...
                axios.put('/pos/admin/update_supplier/' + id, input).then((response) => {
                    this.changePage(this.pagination.current_page);
                    this.fillItem = {
                        'nama_supplier': '',
                        'nama_supplier_old': '',
